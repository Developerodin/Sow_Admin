...
export default function AddCommunicationModel() {
  ...
  return (
    <div>
      <Button onClick={handleOpen} sx={{color:"white",fontWeight:"bold"}}>Add Communication</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          ...
          <MyComponent2 id="outlined-basic" label="Total Chargers" variant="outlined" />
          <MyComponent2
            id="outlined-basic"
            label="Date Added"
            variant="outlined"
