...
export default function AddDiscountModel() {
  ...
  return (
    <div>
      <Button onClick={handleOpen} sx={{color:"white",fontWeight:"bold"}}> Add Coupon</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          ...
          <MyComponent2 id="outlined-basic" label="Starting Date" variant="outlined" />
          <MyComponent2 id="outlined-basic" label="Expire Date" variant="outlined" />
