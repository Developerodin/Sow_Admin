...
export default function AddChargerModel() {
  ...
  return (
    <div>
      <Button onClick={handleOpen} sx={{color:"white",fontWeight:"bold"}}>Add Charger</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          ...
          <MyComponent
            ...
            variant="outlined"
          />
          <MyComponent2 id="outlined-basic" label="Status" variant="outlined" />
          <MyComponent2 id="outlined-basic" label="Alias" variant="outlined" />
