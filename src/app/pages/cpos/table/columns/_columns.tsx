...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='CPO Name' className='min-w-125px' />,
    id: 'cpo_name',
    Cell: ({...props}) => <UserInfoCell user={props.data[props.row.index]} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='CPO ID' className='min-w-125px' />,
    accessor: 'cpo_ID',
  },
  {
    Header: (props) => (
